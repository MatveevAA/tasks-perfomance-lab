...
def get_input():
    """Получаем путь до файлов tests и values"""
...
def get_values(test_list: list, values_json: dict):
    """
    Возвращаем список с заполненными значениями value в словарях
...
def create_report_json(report_list: list):
    """Создаем файл report_json в директории с файлом task3.py
